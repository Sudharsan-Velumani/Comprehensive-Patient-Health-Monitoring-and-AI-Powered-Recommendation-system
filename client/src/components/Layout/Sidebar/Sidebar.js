...
export default function Sidebar({ open, handleDrawerClose, handleDrawerOpen }) {
    ...
    return (
        <Drawer className={styles.sidebar} variant="permanent" open={open} onMouseEnter={handleDrawerOpen} onMouseLeave={handleMouseLeavesDrawer} PaperProps={{ sx: { backgroundColor: '#00248f', color: 'white' } }}>
            <DrawerHeader>
            ...
            <List>
                ...
                {(currentUser.userType == "Patient" || currentUser.userType == "Doctor") && <ListItem key={"Diebetics-Predicton"} disablePadding sx={{ display: 'block' }}>
                    <ListItemButton
                        component={NavLink}
                        to="/Diebetics-Predicton"
                        style={{ textDecoration: 'none', color: 'white' }}
                        selected={selectedItem == "Diebetics-Predicton" ? true : false}
                        sx={{
                            minHeight: 48,
                            justifyContent: open ? 'initial' : 'center',
                            px: 2.5,
                    ...
                    >
                        ...
                        <ListItemText primary={"Diebetics-Predicton"} sx={{ opacity: open ? 1 : 0 }} />
                    </ListItemButton>
                </ListItem>
                }
